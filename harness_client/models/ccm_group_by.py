...
class CCMGroupBy(object):
    ...
    def __init__(self, group_by_field=None):  # noqa: E501
        """CCMGroupBy - a model defined in Swagger"""  # noqa: E501
        self._group_by_field = None
    ...
    def group_by_field(self):
        """Gets the group_by_field of this CCMGroupBy.  # noqa: E501

        List of all possible Fields  # noqa: E501

        :return: The group_by_field of this CCMGroupBy.  # noqa: E501
        :rtype: str
        """
        return self._group_by_field

    @group_by_field.setter
    def group_by_field(self, group_by_field):
        """Sets the group_by_field of this CCMGroupBy.

        List of all possible Fields  # noqa: E501

        :param group_by_field: The group_by_field of this CCMGroupBy.  # noqa: E501
        :type: str
        """
        ...
        if group_by_field not in allowed_values:
            raise ValueError(
                "Invalid value for `group_by_field` ({0}), must be one of {1}"  # noqa: E501
                .format(group_by_field, allowed_values)
            )
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CCMGroupBy):
            return False
