...
class StepType(object):
    ...
    def __init__(self, unknown_fields=None, type=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, type_bytes=None, step_category_value=None, step_category=None, initialized=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
    ...
    def step_category(self, step_category):
        ...
        :type: str
        """
        allowed_values = ["UNKNOWN", "PIPELINE", "STAGE", "STEP", "STAGES", "FORK", "STEP_GROUP", "STRATEGY", "UNRECOGNIZED"]  # noqa: E501
