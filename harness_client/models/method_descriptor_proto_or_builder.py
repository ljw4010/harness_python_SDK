...
class MethodDescriptorProtoOrBuilder(object):
    ...
    def __init__(self, name=None, input_type_bytes=None, output_type_bytes=None, client_streaming=None, server_streaming=None, options=None, output_type=None, input_type=None, options_or_builder=None, name_bytes=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, default_instance_for_type=None, unknown_fields=None, initialized=None):  # noqa: E501
