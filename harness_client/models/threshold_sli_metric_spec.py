...
import six
from swagger_client.models.sli_metric_spec import SLIMetricSpec  # noqa: F401,E501

class ThresholdSLIMetricSpec(SLIMetricSpec):
    ...
    def __init__(self, metric1=None, threshold_value=None, threshold_type=None, consider_consecutive_minutes=None, consider_all_consecutive_minutes_from_start_as_bad=None, *args, **kwargs):  # noqa: E501
        """ThresholdSLIMetricSpec - a model defined in Swagger"""  # noqa: E501
        self._metric1 = None
    ...
    @property
    def metric1(self):
        """Gets the metric1 of this ThresholdSLIMetricSpec.  # noqa: E501


        :return: The metric1 of this ThresholdSLIMetricSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def metric1(self, metric1):
        """Sets the metric1 of this ThresholdSLIMetricSpec.


        :param metric1: The metric1 of this ThresholdSLIMetricSpec.  # noqa: E501
        :type: str
        """
        if metric1 is None:
    ...
    def threshold_value(self):
        """Gets the threshold_value of this ThresholdSLIMetricSpec.  # noqa: E501


        :return: The threshold_value of this ThresholdSLIMetricSpec.  # noqa: E501
        :rtype: float
        """
    ...
    def threshold_value(self, threshold_value):
        """Sets the threshold_value of this ThresholdSLIMetricSpec.


        :param threshold_value: The threshold_value of this ThresholdSLIMetricSpec.  # noqa: E501
        :type: float
        """
    ...
    def threshold_type(self):
        """Gets the threshold_type of this ThresholdSLIMetricSpec.  # noqa: E501


        :return: The threshold_type of this ThresholdSLIMetricSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def threshold_type(self, threshold_type):
        """Sets the threshold_type of this ThresholdSLIMetricSpec.


        :param threshold_type: The threshold_type of this ThresholdSLIMetricSpec.  # noqa: E501
        :type: str
        """
    ...
    def consider_consecutive_minutes(self):
        """Gets the consider_consecutive_minutes of this ThresholdSLIMetricSpec.  # noqa: E501


        :return: The consider_consecutive_minutes of this ThresholdSLIMetricSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def consider_consecutive_minutes(self, consider_consecutive_minutes):
        """Sets the consider_consecutive_minutes of this ThresholdSLIMetricSpec.


        :param consider_consecutive_minutes: The consider_consecutive_minutes of this ThresholdSLIMetricSpec.  # noqa: E501
        :type: int
        """
    ...
    def consider_all_consecutive_minutes_from_start_as_bad(self):
        """Gets the consider_all_consecutive_minutes_from_start_as_bad of this ThresholdSLIMetricSpec.  # noqa: E501


        :return: The consider_all_consecutive_minutes_from_start_as_bad of this ThresholdSLIMetricSpec.  # noqa: E501
        :rtype: bool
        """
    ...
    def consider_all_consecutive_minutes_from_start_as_bad(self, consider_all_consecutive_minutes_from_start_as_bad):
        """Sets the consider_all_consecutive_minutes_from_start_as_bad of this ThresholdSLIMetricSpec.


        :param consider_all_consecutive_minutes_from_start_as_bad: The consider_all_consecutive_minutes_from_start_as_bad of this ThresholdSLIMetricSpec.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ThresholdSLIMetricSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ThresholdSLIMetricSpec):
            return False
