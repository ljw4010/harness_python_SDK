...
class SecretFileSpec(SecretSpec):
    ...
    def __init__(self, type=None, secret_manager_identifier=None, *args, **kwargs):  # noqa: E501
        """SecretFileSpec - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this SecretFileSpec.  # noqa: E501

        This specifies the type of secret  # noqa: E501

        :return: The type of this SecretFileSpec.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this SecretFileSpec.

        This specifies the type of secret  # noqa: E501

        :param type: The type of this SecretFileSpec.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["SecretFile"]  # noqa: E501
    ...
    def secret_manager_identifier(self):
        """Gets the secret_manager_identifier of this SecretFileSpec.  # noqa: E501

        Identifier of the secret manager used to manage the secret  # noqa: E501

        :return: The secret_manager_identifier of this SecretFileSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def secret_manager_identifier(self, secret_manager_identifier):
        """Sets the secret_manager_identifier of this SecretFileSpec.

        Identifier of the secret manager used to manage the secret  # noqa: E501

        :param secret_manager_identifier: The secret_manager_identifier of this SecretFileSpec.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SecretFileSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SecretFileSpec):
            return False
