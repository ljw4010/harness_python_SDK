...
class MessageOptionsOrBuilder(object):
    ...
    def __init__(self, uninterpreted_option_count=None, message_set_wire_format=None, deprecated=None, uninterpreted_option_list=None, uninterpreted_option_or_builder_list=None, map_entry=None, no_standard_descriptor_accessor=None, default_instance_for_type=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, initialized=None):  # noqa: E501
