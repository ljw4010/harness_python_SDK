...
class GitFullSyncEntityInfoFilter(object):
    ...
    def __init__(self, entity_types=None, sync_status=None):  # noqa: E501
        """GitFullSyncEntityInfoFilter - a model defined in Swagger"""  # noqa: E501
    ...
    def entity_types(self):
        """Gets the entity_types of this GitFullSyncEntityInfoFilter.  # noqa: E501

        List of entity Types to filter on the entities.  # noqa: E501

        :return: The entity_types of this GitFullSyncEntityInfoFilter.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def entity_types(self, entity_types):
        """Sets the entity_types of this GitFullSyncEntityInfoFilter.

        List of entity Types to filter on the entities.  # noqa: E501

        :param entity_types: The entity_types of this GitFullSyncEntityInfoFilter.  # noqa: E501
        :type: list[str]
        """
    ...
    def sync_status(self):
        """Gets the sync_status of this GitFullSyncEntityInfoFilter.  # noqa: E501

        Sync Status of the Entity that may be QUEUED, SUCCESS or FAILED.  # noqa: E501

        :return: The sync_status of this GitFullSyncEntityInfoFilter.  # noqa: E501
        :rtype: str
        """
    ...
    def sync_status(self, sync_status):
        """Sets the sync_status of this GitFullSyncEntityInfoFilter.

        Sync Status of the Entity that may be QUEUED, SUCCESS or FAILED.  # noqa: E501

        :param sync_status: The sync_status of this GitFullSyncEntityInfoFilter.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GitFullSyncEntityInfoFilter, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GitFullSyncEntityInfoFilter):
            return False
