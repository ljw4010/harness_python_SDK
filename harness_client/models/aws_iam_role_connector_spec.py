...
class AwsIAMRoleConnectorSpec(ConnectorSpec):
    ...
    def __init__(self, type=None, cross_account_role_arn=None, external_id=None, test_region=None, delegate_selectors=None, execute_on_delegate=True, *args, **kwargs):  # noqa: E501
        """AwsIAMRoleConnectorSpec - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this AwsIAMRoleConnectorSpec.  # noqa: E501

        This specifies the type of connector  # noqa: E501

        :return: The type of this AwsIAMRoleConnectorSpec.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this AwsIAMRoleConnectorSpec.

        This specifies the type of connector  # noqa: E501

        :param type: The type of this AwsIAMRoleConnectorSpec.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["AwsIAMRole"]  # noqa: E501
    ...
    def cross_account_role_arn(self):
        """Gets the cross_account_role_arn of this AwsIAMRoleConnectorSpec.  # noqa: E501
        ...
        :return: The cross_account_role_arn of this AwsIAMRoleConnectorSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def cross_account_role_arn(self, cross_account_role_arn):
        """Sets the cross_account_role_arn of this AwsIAMRoleConnectorSpec.

        If you want to use one AWS account for the connection, but you want to deploy or build in a different AWS account. In this scenario, the AWS account used for AWS access in Credentials will assume the IAM role you specify in Cross-account role ARN setting. This option uses the AWS Security Token Service (STS) feature.  # noqa: E501

        :param cross_account_role_arn: The cross_account_role_arn of this AwsIAMRoleConnectorSpec.  # noqa: E501
        :type: str
        """
    ...
    def external_id(self):
        """Gets the external_id of this AwsIAMRoleConnectorSpec.  # noqa: E501
        ...
        :return: The external_id of this AwsIAMRoleConnectorSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this AwsIAMRoleConnectorSpec.

        If the administrator of the account to which the role belongs provided you with an external ID, then enter that value.  # noqa: E501

        :param external_id: The external_id of this AwsIAMRoleConnectorSpec.  # noqa: E501
        :type: str
        """
    ...
    def test_region(self):
        """Gets the test_region of this AwsIAMRoleConnectorSpec.  # noqa: E501
        ...
        :return: The test_region of this AwsIAMRoleConnectorSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def test_region(self, test_region):
        """Sets the test_region of this AwsIAMRoleConnectorSpec.

        By default, Harness uses the us-east-1 region to test the credentials for this Connector. If you want to use an AWS GovCloud account for this Connector, select it in Test Region. GovCloud is used by organizations such as government agencies at the federal, state, and local level, as well as contractors, educational institutions. It is also used for regulatory compliance with these organizations.  # noqa: E501

        :param test_region: The test_region of this AwsIAMRoleConnectorSpec.  # noqa: E501
        :type: str
        """
    ...
    def delegate_selectors(self):
        """Gets the delegate_selectors of this AwsIAMRoleConnectorSpec.  # noqa: E501

        List of unique delegate selectors  # noqa: E501

        :return: The delegate_selectors of this AwsIAMRoleConnectorSpec.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def delegate_selectors(self, delegate_selectors):
        """Sets the delegate_selectors of this AwsIAMRoleConnectorSpec.

        List of unique delegate selectors  # noqa: E501

        :param delegate_selectors: The delegate_selectors of this AwsIAMRoleConnectorSpec.  # noqa: E501
        :type: list[str]
        """
    ...
    def execute_on_delegate(self):
        """Gets the execute_on_delegate of this AwsIAMRoleConnectorSpec.  # noqa: E501

        execute on delegate  # noqa: E501

        :return: The execute_on_delegate of this AwsIAMRoleConnectorSpec.  # noqa: E501
        :rtype: bool
        """
    ...
    def execute_on_delegate(self, execute_on_delegate):
        """Sets the execute_on_delegate of this AwsIAMRoleConnectorSpec.

        execute on delegate  # noqa: E501

        :param execute_on_delegate: The execute_on_delegate of this AwsIAMRoleConnectorSpec.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AwsIAMRoleConnectorSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AwsIAMRoleConnectorSpec):
            return False
