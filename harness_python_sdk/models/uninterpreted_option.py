...
class UninterpretedOption(object):
    ...
    def __init__(self, unknown_fields=None, name_count=None, string_value=None, double_value=None, initialized=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, name_list=None, name_or_builder_list=None, identifier_value=None, identifier_value_bytes=None, positive_int_value=None, negative_int_value=None, aggregate_value=None, aggregate_value_bytes=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
