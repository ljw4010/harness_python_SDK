...
class NamePart(object):
    ...
    def __init__(self, unknown_fields=None, name_part=None, name_part_bytes=None, is_extension=None, initialized=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
