...
class AccessDeniedError(object):
    ...
    swagger_types = {
        ...
        'response_messages': 'list[AuthzResponseMessage]',
        'metadata': 'AuthzErrorMetadata',
        'failed_permission_checks': 'list[PermissionCheck]'
    }
    ...
    attribute_map = {
        ...
        'metadata': 'metadata',
        'failed_permission_checks': 'failedPermissionChecks'
    }

    def __init__(self, status=None, code=None, message=None, correlation_id=None, detailed_message=None, response_messages=None, metadata=None, failed_permission_checks=None):  # noqa: E501
        """AccessDeniedError - a model defined in Swagger"""  # noqa: E501
        self._status = None
        self._code = None
        self._message = None
        ...
        self._metadata = None
        self._failed_permission_checks = None
        ...
        if failed_permission_checks is not None:
            self.failed_permission_checks = failed_permission_checks

    @property
    def status(self):
        """Gets the status of this AccessDeniedError.  # noqa: E501


        :return: The status of this AccessDeniedError.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this AccessDeniedError.


        :param status: The status of this AccessDeniedError.  # noqa: E501
        :type: str
        """
    ...
    @property
    def code(self):
        """Gets the code of this AccessDeniedError.  # noqa: E501


        :return: The code of this AccessDeniedError.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this AccessDeniedError.


        :param code: The code of this AccessDeniedError.  # noqa: E501
        :type: str
        """
    ...
    @property
    def message(self):
        """Gets the message of this AccessDeniedError.  # noqa: E501


        :return: The message of this AccessDeniedError.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this AccessDeniedError.


        :param message: The message of this AccessDeniedError.  # noqa: E501
        :type: str
        """
    ...
    def correlation_id(self):
        """Gets the correlation_id of this AccessDeniedError.  # noqa: E501


        :return: The correlation_id of this AccessDeniedError.  # noqa: E501
        :rtype: str
        """
    ...
    def correlation_id(self, correlation_id):
        """Sets the correlation_id of this AccessDeniedError.


        :param correlation_id: The correlation_id of this AccessDeniedError.  # noqa: E501
        :type: str
        """
    ...
    def detailed_message(self):
        """Gets the detailed_message of this AccessDeniedError.  # noqa: E501


        :return: The detailed_message of this AccessDeniedError.  # noqa: E501
        :rtype: str
        """
    ...
    def detailed_message(self, detailed_message):
        """Sets the detailed_message of this AccessDeniedError.


        :param detailed_message: The detailed_message of this AccessDeniedError.  # noqa: E501
        :type: str
        """
    ...
    def response_messages(self):
        """Gets the response_messages of this AccessDeniedError.  # noqa: E501


        :return: The response_messages of this AccessDeniedError.  # noqa: E501
        :rtype: list[AuthzResponseMessage]
        """
        return self._response_messages

    @response_messages.setter
    def response_messages(self, response_messages):
        """Sets the response_messages of this AccessDeniedError.


        :param response_messages: The response_messages of this AccessDeniedError.  # noqa: E501
        :type: list[AuthzResponseMessage]
        """
    ...
    @property
    def metadata(self):
        """Gets the metadata of this AccessDeniedError.  # noqa: E501


        :return: The metadata of this AccessDeniedError.  # noqa: E501
        :rtype: AuthzErrorMetadata
        """
        return self._metadata

    @metadata.setter
    def metadata(self, metadata):
        """Sets the metadata of this AccessDeniedError.


        :param metadata: The metadata of this AccessDeniedError.  # noqa: E501
        :type: AuthzErrorMetadata
        """

        self._metadata = metadata

    @property
    def failed_permission_checks(self):
        """Gets the failed_permission_checks of this AccessDeniedError.  # noqa: E501


        :return: The failed_permission_checks of this AccessDeniedError.  # noqa: E501
        :rtype: list[PermissionCheck]
        """
        return self._failed_permission_checks

    @failed_permission_checks.setter
    def failed_permission_checks(self, failed_permission_checks):
        """Sets the failed_permission_checks of this AccessDeniedError.


        :param failed_permission_checks: The failed_permission_checks of this AccessDeniedError.  # noqa: E501
        :type: list[PermissionCheck]
        """

        self._failed_permission_checks = failed_permission_checks
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AccessDeniedError, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccessDeniedError):
            return False
