...
class MethodDescriptor(object):
    ...
    def __init__(self, index=None, proto=None, full_name=None, file=None, service=None, input_type=None, output_type=None, name=None, client_streaming=None, server_streaming=None, options=None):  # noqa: E501
