...
class UnknownFieldSet(object):
    ...
    def __init__(self, initialized=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, serialized_size_as_message_set=None):  # noqa: E501
