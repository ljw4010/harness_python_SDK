...
class CostDetailsQueryParams(object):
    ...
    def __init__(self, filters=None, group_by=None, time_resolution=None, limit=None, sort_order=None, offset=None, skip_round_off=None):  # noqa: E501
        """CostDetailsQueryParams - a model defined in Swagger"""  # noqa: E501
        self._filters = None
        self._group_by = None
    ...
    @property
    def filters(self):
        """Gets the filters of this CostDetailsQueryParams.  # noqa: E501

        Filters to be applied on the response.  # noqa: E501

        :return: The filters of this CostDetailsQueryParams.  # noqa: E501
    ...
    def filters(self, filters):
        """Sets the filters of this CostDetailsQueryParams.

        Filters to be applied on the response.  # noqa: E501

        :param filters: The filters of this CostDetailsQueryParams.  # noqa: E501
    ...
    @property
    def group_by(self):
        """Gets the group_by of this CostDetailsQueryParams.  # noqa: E501

        Fields on which the response will be grouped by.  # noqa: E501

        :return: The group_by of this CostDetailsQueryParams.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def group_by(self, group_by):
        """Sets the group_by of this CostDetailsQueryParams.

        Fields on which the response will be grouped by.  # noqa: E501

        :param group_by: The group_by of this CostDetailsQueryParams.  # noqa: E501
        :type: list[str]
        """
    ...
    def time_resolution(self):
        """Gets the time_resolution of this CostDetailsQueryParams.  # noqa: E501

        Only applicable for Time Series Endpoints, defaults to DAY  # noqa: E501

        :return: The time_resolution of this CostDetailsQueryParams.  # noqa: E501
        :rtype: str
        """
    ...
    def time_resolution(self, time_resolution):
        """Sets the time_resolution of this CostDetailsQueryParams.

        Only applicable for Time Series Endpoints, defaults to DAY  # noqa: E501

        :param time_resolution: The time_resolution of this CostDetailsQueryParams.  # noqa: E501
        :type: str
        """
    ...
    @property
    def limit(self):
        """Gets the limit of this CostDetailsQueryParams.  # noqa: E501

        Limit on the number of cost values returned, 0 by default.  # noqa: E501

        :return: The limit of this CostDetailsQueryParams.  # noqa: E501
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        """Sets the limit of this CostDetailsQueryParams.

        Limit on the number of cost values returned, 0 by default.  # noqa: E501

        :param limit: The limit of this CostDetailsQueryParams.  # noqa: E501
        :type: int
        """
    ...
    @property
    def sort_order(self):
        """Gets the sort_order of this CostDetailsQueryParams.  # noqa: E501

        Order of sorting on cost, Descending by default.  # noqa: E501

        :return: The sort_order of this CostDetailsQueryParams.  # noqa: E501
        :rtype: str
        """
    ...
    def sort_order(self, sort_order):
        """Sets the sort_order of this CostDetailsQueryParams.

        Order of sorting on cost, Descending by default.  # noqa: E501

        :param sort_order: The sort_order of this CostDetailsQueryParams.  # noqa: E501
        :type: str
        """
    ...
    @property
    def offset(self):
        """Gets the offset of this CostDetailsQueryParams.  # noqa: E501

        Offset on the cost values returned, 10 by default.  # noqa: E501

        :return: The offset of this CostDetailsQueryParams.  # noqa: E501
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        """Sets the offset of this CostDetailsQueryParams.

        Offset on the cost values returned, 10 by default.  # noqa: E501

        :param offset: The offset of this CostDetailsQueryParams.  # noqa: E501
        :type: int
        """
    ...
    def skip_round_off(self):
        """Gets the skip_round_off of this CostDetailsQueryParams.  # noqa: E501

        Skip Rounding off the cost values returned, false by default.  # noqa: E501

        :return: The skip_round_off of this CostDetailsQueryParams.  # noqa: E501
        :rtype: bool
        """
    ...
    def skip_round_off(self, skip_round_off):
        """Sets the skip_round_off of this CostDetailsQueryParams.

        Skip Rounding off the cost values returned, false by default.  # noqa: E501

        :param skip_round_off: The skip_round_off of this CostDetailsQueryParams.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CostDetailsQueryParams, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CostDetailsQueryParams):
            return False
