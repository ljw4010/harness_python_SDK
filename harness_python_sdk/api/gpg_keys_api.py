...
class GPGKeysApi(object):
    ...
    def gnu_pg_key_service_list_gpg_keys(self, account_identifier, **kwargs):  # noqa: E501
        """List all available repository certificates  # noqa: E501

        List all available repository certificates  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.gnu_pg_key_service_list_gpg_keys(account_identifier, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.gnu_pg_key_service_list_gpg_keys_with_http_info(account_identifier, **kwargs)  # noqa: E501
        else:
            (data) = self.gnu_pg_key_service_list_gpg_keys_with_http_info(account_identifier, **kwargs)  # noqa: E501
            return data

    def gnu_pg_key_service_list_gpg_keys_with_http_info(self, account_identifier, **kwargs):  # noqa: E501
        """List all available repository certificates  # noqa: E501

        List all available repository certificates  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.gnu_pg_key_service_list_gpg_keys_with_http_info(account_identifier, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['account_identifier', 'org_identifier', 'project_identifier', 'gnu_pg', 'search_term', 'page_size', 'page_index', 'agent_identifier']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method gnu_pg_key_service_list_gpg_keys" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('account_identifier' not in params or
            ...
            raise ValueError("Missing the required parameter `account_identifier` when calling `gnu_pg_key_service_list_gpg_keys`")  # noqa: E501
        ...
        if 'gnu_pg' in params:
            query_params.append(('gnuPG', params['gnu_pg']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='Servicev1GnuPGPublicKeyList',  # noqa: E501
