...
class PipelineRefreshApi(object):
    ...
    def validate_template_inputs(self, account_identifier, **kwargs):  # noqa: E501
        """Validates template inputs in a pipeline's YAML specification.  # noqa: E501
        ...
        >>> thread = api.validate_template_inputs(account_identifier, async_req=True)
        >>> result = thread.get()
        ...
        :return: ResponseDTOValidateTemplateInputsResponseDTO
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.validate_template_inputs_with_http_info(account_identifier, **kwargs)  # noqa: E501
        else:
            (data) = self.validate_template_inputs_with_http_info(account_identifier, **kwargs)  # noqa: E501
            return data

    def validate_template_inputs_with_http_info(self, account_identifier, **kwargs):  # noqa: E501
        """Validates template inputs in a pipeline's YAML specification.  # noqa: E501

        Validates the template inputs in a pipeline's YAML specification. If the template inputs are invalid, the operation returns an error summary.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.validate_template_inputs_with_http_info(account_identifier, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['account_identifier', 'org_identifier', 'project_identifier', 'identifier', 'load_from_cache', 'branch', 'repo_identifier', 'get_default_from_other_repo']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method validate_template_inputs" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('account_identifier' not in params or
            ...
            raise ValueError("Missing the required parameter `account_identifier` when calling `validate_template_inputs`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pipeline/api/refresh-template/validate-template-inputs', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='ResponseDTOValidateTemplateInputsResponseDTO',  # noqa: E501
