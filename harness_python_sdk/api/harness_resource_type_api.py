...
class HarnessResourceTypeApi(object):
    ...
    def get_resource_types(self, account_identifier, **kwargs):  # noqa: E501
        """Gets all resource types available at this scope  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_resource_types(account_identifier, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_resource_types_with_http_info(account_identifier, **kwargs)  # noqa: E501
        else:
            (data) = self.get_resource_types_with_http_info(account_identifier, **kwargs)  # noqa: E501
            return data

    def get_resource_types_with_http_info(self, account_identifier, **kwargs):  # noqa: E501
        """Gets all resource types available at this scope  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_resource_types_with_http_info(account_identifier, async_req=True)
        >>> result = thread.get()
        ...
        if ('account_identifier' not in params or
            ...
            raise ValueError("Missing the required parameter `account_identifier` when calling `get_resource_types`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/resourcegroup/api/resourcetype', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='ResponseDTOResourceType',  # noqa: E501
