...
class TestGnuPGPKeysApi(unittest.TestCase):
    """GnuPGPKeysApi unit test stubs"""

    def setUp(self):
        self.api = GnuPGPKeysApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_agent_gpg_key_service_create(self):
        """Test case for agent_gpg_key_service_create

        Create one or more GPG public keys in the server's configuration  # noqa: E501
        """
        pass

    def test_agent_gpg_key_service_delete(self):
        """Test case for agent_gpg_key_service_delete

        Delete specified GPG public key from the server's configuration  # noqa: E501
        """
        pass

    def test_agent_gpg_key_service_get(self):
        """Test case for agent_gpg_key_service_get
