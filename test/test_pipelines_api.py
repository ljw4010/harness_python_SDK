...
from harness_python_sdk.api.pipelines_api import PipelinesApi  # noqa: E501
...
class TestPipelinesApi(unittest.TestCase):
    ...
    def test_import_pipeline_from_git(self):
        """Test case for import_pipeline_from_git
    ...
    def test_update_pipeline_git_metadata(self):
        """Test case for update_pipeline_git_metadata
