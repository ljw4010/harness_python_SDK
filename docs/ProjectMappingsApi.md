# swagger_client.ProjectMappingsApi
...
api_instance = swagger_client.ProjectMappingsApi(swagger_client.ApiClient(configuration))
body = swagger_client.Servicev1AppProjectMapping() # Servicev1AppProjectMapping | 
