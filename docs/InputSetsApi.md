...
api_instance = swagger_client.InputSetsApi(swagger_client.ApiClient(configuration))
body = swagger_client.InputSetCreateRequestBody() # InputSetCreateRequestBody | Input Set create request body.
...
project = 'project_example' # str | Project identifier
input_set = 'input_set_example' # str | Input Set identifier
body = swagger_client.InputSetImportRequestBody() # InputSetImportRequestBody | Input Set import request body (optional)
harness_account = 'harness_account_example' # str | Identifier field of the account the resource is scoped to. This is required for Authorization methods other than the x-api-key header. If you are using the x-api-key header, this can be skipped. (optional)
...
project = 'project_example' # str | Project identifier
input_set = 'input_set_example' # str | Input Set identifier
body = swagger_client.InputSetMoveConfigRequestBody() # InputSetMoveConfigRequestBody |  (optional)
harness_account = 'harness_account_example' # str | Identifier field of the account the resource is scoped to. This is required for Authorization methods other than the x-api-key header. If you are using the x-api-key header, this can be skipped. (optional)
...
# create an instance of the API class
api_instance = swagger_client.InputSetsApi(swagger_client.ApiClient(configuration))
body = swagger_client.InputSetUpdateRequestBody() # InputSetUpdateRequestBody | Input Set update request body
pipeline = 'pipeline_example' # str | Pipeline identifier for the Input Set.
org = 'org_example' # str | Organization identifier
project = 'project_example' # str | Project identifier
input_set = 'input_set_example' # str | Input Set identifier
